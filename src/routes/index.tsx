...
function HomePage(){return <div className="v2-home">
  ...
  <section className="v2-final-cta"><div className="editorial-container v2-final-grid"><div className="v2-section-index">06 / CONTACT</div><div><h2>MAKE THE<br/><span>NEXT MOVE.</span></h2><p>Representation. Press. Partnerships. Booking. Production. Licensing. Communications.</p><Link to="/contact" className="v2-solid-btn">Start a Conversation ↗</Link></div></div></section>
</div>}
